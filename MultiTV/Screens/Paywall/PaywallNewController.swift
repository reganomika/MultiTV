...
class PaywallNewController: OnboardingController {
    ...
    private lazy var customSwitch: BaseSwitchView = {
        ...
        customSwitch.onRightSelected = { [weak self] in
    ...
    let highlightedText: String = "Next Level".localized
    ...
    init(isFromOnboarding: Bool) {
        ...
        super.init(
            model: OnboardingModel(image: UIImage(), title: "", higlitedText: "", subtitle: "", rating: false),
            coordinator: nil
        )
    }
    ...
    override func viewDidLoad() {
        ...
        customTitle = "Take Your Remote to the Next Level".localized
        ...
        customSwitch.snp.makeConstraints { make in
            make.bottom.equalTo(nextButton.snp.top).inset(-24)
            make.leading.trailing.equalToSuperview().inset(27)
            make.height.equalTo(53)
        }
        
        subtitleLabel.snp.updateConstraints { make in
            make.bottom.equalTo(nextButton.snp.top).inset(-101)
        }
    }
